...
# 3. Run benchmarks
echo "Running List-based benchmark..."
./build/bench_list ../data/synthetic.itch latency_list.csv

echo "Running Vector-based benchmark..."
./build/bench_vector ../data/synthetic.itch latency_vector.csv
